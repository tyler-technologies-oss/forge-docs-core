...
const PropertyDefName: FC<IPropertyDefName> = ({ name, prop, attr }) => {
  return (
    <div className="tyl-forge__property-def-name">
...
const PropertyDef: FC<IPropertyDef> = ({ name, prop = true, attr = true, type, defaultValue, children }) => {
  return (
    <tcw-card outlined has-padding="false">
      <div className="tyl-forge__property-def">
        <PropertyDefName name={name} prop={prop} attr={attr} />
        <div className="tyl-forge__property-def-header">
          ...
          {type && <tcw-label-value>
            ...
            <code slot="value" className="tyl-forge__inline-code">{type}</code>
          </tcw-label-value>}
          {defaultValue && <tcw-label-value>
            <span slot="label">Default</span>
            <code slot="value" className="tyl-forge__inline-code">{defaultValue}</code>
          </tcw-label-value>}
        </div>
        {children}
      </div>
